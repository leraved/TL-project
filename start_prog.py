# -*- coding: utf-8 -*-
"""
Created on Thu May  9 01:35:16 2019
...
def rules():
    ...
    lable2 = Label(
        text="Игрок и компьютер по очереди ставят на свободные клетки поля 3х3 знаки\n (один всегда крестики, другой всегда нолики).\n Первый, выстроивший в ряд 3 своих фигуры по вертикали,\n горизонтали или диагонали, выигрывает. \n Первый ход делает игрок, он ставит крестики.",
        font="Arial 25", justify=CENTER, bg="white").place(x=700, y=300, anchor="center")
